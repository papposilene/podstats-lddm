            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control border border-primary" value="<?php echo e($game->title); ?>" disabled="disabled" required />
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-primary border border-primary text-white">
                ...
                <input type="hidden" name="item_model" value="game" required />
                <input type="hidden" name="item_uuid" id="item_uuid" value="<?php echo e($game->uuid); ?>" required />
...
</div><?php /**PATH /srv/data/web/vhosts/lddm.psln.nl/resources/views/modals/sourceGameCreate.blade.php ENDPATH**/ ?>