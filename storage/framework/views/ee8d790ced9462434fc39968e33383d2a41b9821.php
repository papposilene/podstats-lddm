        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div class="row">
                <div class="col-8">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.game.store')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control border border-primary" name="game_title" placeholder="<?php echo ucfirst(__('app.gameTitle')); ?>" aria-label="<?php echo ucfirst(__('app.gameTitle')); ?>" aria-describedby="form_title">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                            ...
                            <input type="text" class="form-control border border-primary" name="game_releasedOn" placeholder="<?php echo e(__('app.ddmmyy')); ?>" aria-label="<?php echo ucfirst(__('app.gameDate')); ?>" aria-describedby="form_date">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-control border border-primary" name="studio_uuid" aria-label="<?php echo ucfirst(__('app.profession')); ?>" aria-describedby="form_studio">
                                ...
                                <option value="<?php echo e($studio->uuid); ?>"><?php echo e($studio->studio); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="form-row mt-2">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/philippe-alexandrepierre/Sites/laravel/laravel-podcast/resources/views/admin/game/create.blade.php ENDPATH**/ ?>