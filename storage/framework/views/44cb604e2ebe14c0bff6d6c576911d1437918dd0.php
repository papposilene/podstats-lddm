...
<div class="row row-cols-1 row-cols-md-3 mt-2">
    <div class="col mb-4">
        <div class="card">
            <h1 class="h5 card-header">
                ...
                <span class="float-right"><?php echo e($studio->locatedAt->flag); ?></span>
            </h1>
            <ul class="list-group list-group-flush">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <span><?php echo ucfirst(__('app.statGameByStudioTotal')); ?></span>
            ...
            <p class="card-text text-center">
                <small class="text-muted"><?php echo e(__('app.updatedAt')); ?> <?php echo ($studio->updated_at)->format('d/m/Y @ H:i'); ?></small>
            </p>
        </div>
    </div>
    <div class="col mb-4">
    ...
    <div class="col mb-4">
        <div class="card">
            <h3 class="h5 card-header"><?php echo ucfirst(__('app.statGameModes')); ?></h3>
            <div class="card-body">
    ...
    <div class="col-md-6 col-12">
        <div class="list-group list-group-flush">
            ...
            <a href="<?php echo e(route('public.game.show', ['uuid' => $game->uuid])); ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                <span>
                    <strong><?php echo e($game->title); ?></strong>, <?php if($game->released_on): ?> <?php echo ($game->released_on)->format('Y'); ?>. <?php else: ?> 19??. <?php endif; ?><br />
                    <em><?php echo ucfirst(__('app.onConsoles', ['count' => count($game->hasConsoles)])); ?></em>
                </span>
...
$.getJSON("<?php echo e(route('api.studio.genres', ['uuid' => $studio->uuid, 'count' => 10])); ?>", function (json) {
...
$.getJSON("<?php echo e(route('api.studio.modes', ['uuid' => $studio->uuid, 'count' => 10])); ?>", function (json) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/data/web/vhosts/lddm.psln.nl/resources/views/public/studio/show.blade.php ENDPATH**/ ?>