...
<div class="row">
    <div class="col-8">
        ...
        <form method="POST" action="<?php echo e(route('admin.game.update')); ?>" name="game_editor" class="needs-validation" novalidate />
            <?php echo csrf_field(); ?>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control border border-primary" name="game_title" value="<?php echo e($game->title); ?>" placeholder="<?php echo ucfirst(__('app.gameTitle')); ?>" aria-label="<?php echo ucfirst(__('app.gameTitle')); ?>" aria-describedby="form_title" required />
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                ...
                <input type="text" class="form-control border border-primary" name="game_releasedOn" value="<?php if($game->released_on): ?><?php echo ($game->released_on)->format('Y-m-d'); ?><?php endif; ?>" placeholder="<?php echo e(__('app.ddmmyy')); ?>" aria-label="<?php echo ucfirst(__('app.gameDate')); ?>" aria-describedby="form_date" required />
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                ...
                <select multiple class="form-control border border-primary" name="modes[]" aria-label="<?php echo ucfirst(__('app.gameGenre')); ?>" aria-describedby="form_mode" required />
            ...
            <div class="input-group mb-3">
                ...
                <select multiple class="form-control border border-primary" name="genres[]" size="10" aria-label="<?php echo ucfirst(__('app.gameMode')); ?>" aria-describedby="form_genre" required />
                    ...
                    <option value="<?php echo e($genre->uuid); ?>" <?php if($game->hasGenres->contains($genre->uuid)): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($genre->genre); ?></option>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control border border-primary" id="studio_name" name="studio_name" value="<?php if($game->studio_uuid): ?><?php echo e($game->createdBy->studio); ?><?php endif; ?>" placeholder="<?php echo ucfirst(__('app.studio')); ?>" autocomplete="off" aria-label="<?php echo ucfirst(__('app.studio')); ?>" required />
            </div>
            <div class="form-row mt-2">
                <div class="col">
            ...
            <div class="input-group mb-3">
                ...
                <select multiple class="form-control border border-primary" name="consoles[]" size="10" aria-label="<?php echo ucfirst(__('app.console')); ?>" aria-describedby="form_consoles" required />
                    ...
                    <option value="<?php echo e($console->uuid); ?>" <?php if($game->hasConsoles->contains($console->uuid)): ?> <?php echo e('selected'); ?><?php endif; ?>><?php echo e($console->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <input type="hidden" name="studio_uuid" id="studio_uuid" value="<?php if($game->studio_uuid): ?><?php echo e($game->studio_uuid); ?><?php endif; ?>" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/data/web/vhosts/lddm.psln.nl/resources/views/admin/game/edit.blade.php ENDPATH**/ ?>