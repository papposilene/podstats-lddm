                ...
                <table class="table table-dark table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">
                                <?php echo ucfirst(__('app.studio')); ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo e(count($studio->hasGames)); ?></td>
...
<?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/data/web/vhosts/lddm.psln.nl/resources/views/admin/studio/admin.blade.php ENDPATH**/ ?>