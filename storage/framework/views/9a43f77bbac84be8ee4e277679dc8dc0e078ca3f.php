...
<div class="modal fade" id="modalStaffAdd" tabindex="-1" role="dialog" aria-labelledby="modalStaffAddTitle" aria-hidden="true">
    <form method="POST" action="<?php echo e(route('admin.link.game')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
</div><?php /**PATH /srv/data/web/vhosts/lddm.psln.nl/resources/views/modals/relationContactCreate.blade.php ENDPATH**/ ?>