                ...
                <table class="table table-dark table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center"><?php echo ucfirst(__('app.company')); ?></th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('admin.manufacturer.show', ['uuid' => $console->manufacturer_uuid])); ?>">
                                    <?php echo e($console->byManufacturer->company); ?>

                                </a>
                            </td>
                            <td><?php echo e($console->name); ?></td>
                            <td class="text-center"><?php echo e($console->released_on); ?></td>
...
<?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/data/web/vhosts/lddm.psln.nl/resources/views/admin/console/admin.blade.php ENDPATH**/ ?>