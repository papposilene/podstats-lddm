...
<div class="modal fade" id="modalEpisodeImport" tabindex="-1" role="dialog" aria-labelledby="modalEpisodeImportTitle" aria-hidden="true">
    <form method="POST" action="<?php echo e(route('admin.episode.import')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
</div><?php /**PATH /Users/philippe-alexandrepierre/Sites/laravel/laravel-podcast/resources/views/modals/episodeImport.blade.php ENDPATH**/ ?>