...
<div class="row row-cols-1 row-cols-md-2 mt-2">
    <div class="col mb-4">
        <div class="card">
            <h1 class="h5 card-header"><?php echo ucfirst(__('app.studiosList')); ?></h1>
            <div class="list-group list-group-flush">
                ...
                <a href="<?php echo e(route('public.stats.studios')); ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                    <span><?php echo ucfirst(__('app.statMore')); ?></span>
                    <span class="badge badge-primary badge-pill">></span>
                </a>
            </div>
            <form action="<?php echo e(route('public.studio.search')); ?>" method="POST" class="card-body">
                <?php echo csrf_field(); ?>
...
<div class="row">
    <?php $__currentLoopData = $studios->chunk(15); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="col-md-6 col-12">
        <div class="list-group list-group-flush">
            <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('public.studio.show', ['uuid' => $studio->uuid])); ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                <span>
                    <strong><?php echo e($studio->studio); ?></strong><br />
                    <em><?php echo e($studio->locatedAt->flag); ?> <?php echo e($studio->locatedAt->name_eng_common); ?></em>
                </span>
                <span class="badge badge-primary badge-pill"><?php echo e(count($studio->hasGames)); ?></span>
            </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/data/web/vhosts/lddm.psln.nl/resources/views/public/studio/index.blade.php ENDPATH**/ ?>