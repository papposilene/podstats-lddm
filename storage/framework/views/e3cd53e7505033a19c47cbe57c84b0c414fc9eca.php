    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card-body d-flex h-100">
                <h1 class="card-title text-center align-self-center w-100">
                    <?php echo ucfirst(__('app.tracksList')); ?> : <br />
                    <em><?php echo ucfirst(__('app.trackType' . ucfirst($type))); ?></em>.
                </h1>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <div class="col-md-6 col-12">
        <div class="list-group list-group-flush">
            ...
            <a href="<?php echo e(route('public.track.show', ['uuid' => $track->track_uuid])); ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                <span>
                    <?php echo e($track->hasTrack->title); ?><br />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/data/web/vhosts/lddm.psln.nl/resources/views/public/track/type.blade.php ENDPATH**/ ?>