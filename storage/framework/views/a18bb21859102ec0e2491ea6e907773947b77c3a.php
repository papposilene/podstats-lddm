    ...
    <table class="table table-dark table-striped table-hover">
        <thead>
            <tr>
                ...
                <th class="text-center">
                    <?php echo ucfirst(__('app.serieName')); ?>
                ...
                <th class="text-center"><?php echo ucfirst(__('app.serieCount')); ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo e(route('admin.serie.show', ['uuid' => $serie->uuid])); ?>">
                        <?php echo e($serie->serie); ?>

                    </a>
                </td>
                <td class="text-center">
                    <?php echo e(count($serie->hasGames)); ?>
                ...
                <td class="text-center">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.serie.delete')); ?>" class="">
                        ...
                        <a href="<?php echo e(route('admin.serie.show', ['uuid' => $serie->uuid])); ?>" class="btn btn-sm btn-primary">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/data/web/vhosts/lddm.psln.nl/resources/views/admin/serie/index.blade.php ENDPATH**/ ?>