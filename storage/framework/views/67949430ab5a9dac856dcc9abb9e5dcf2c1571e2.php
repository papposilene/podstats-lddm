...
<div class="modal fade" id="modalGenreCreate" tabindex="-1" role="dialog" aria-labelledby="modalGenreCreateTitle" aria-hidden="true">
    <form method="POST" action="<?php echo e(route('admin.genre.store')); ?>" class="needs-validation" novalidate />
        <?php echo csrf_field(); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control border border-primary" name="genre_name" placeholder="<?php echo ucfirst(__('app.genre')); ?>" aria-label="<?php echo ucfirst(__('app.genre')); ?>" required />
                    </div>
                </div>
...
</div><?php /**PATH /srv/data/web/vhosts/lddm.psln.nl/resources/views/modals/genreCreate.blade.php ENDPATH**/ ?>