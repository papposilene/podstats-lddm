                ...
                <div class="col mb-4">
                    <div class="card">
                        ...
                        <div class="list-group list-group-flush">
                            <a href="<?php echo e(route('admin.manufacturer.index')); ?>" class="list-group-item list-group-item-action list-group-item-dark d-flex justify-content-between align-items-center">
                                <span>
                            ...
                            <a href="<?php echo e(route('admin.console.index')); ?>" class="list-group-item list-group-item-action list-group-item-dark d-flex justify-content-between align-items-center">
                                <span>
							...
							<a href="<?php echo e(route('admin.contact.index')); ?>" class="list-group-item list-group-item-action list-group-item-dark d-flex justify-content-between align-items-center">
                                <span>
                                    <i class="fas fa-dice" aria-hidden="true"></i>
                            ...
                            <a href="<?php echo e(route('admin.studio.index')); ?>" class="list-group-item list-group-item-action list-group-item-dark d-flex justify-content-between align-items-center">
                                <span>
                            ...
                            <a href="<?php echo e(route('admin.game.index')); ?>" class="list-group-item list-group-item-action list-group-item-dark d-flex justify-content-between align-items-center">
                                <span>
							...
							<a href="<?php echo e(route('admin.track.index')); ?>" class="list-group-item list-group-item-action list-group-item-dark d-flex justify-content-between align-items-center">
                                <span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/philippe-alexandrepierre/Sites/laravel/laravel-podcast/resources/views/public/index.blade.php ENDPATH**/ ?>