            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control border border-primary" value="{{ $game->title }}" disabled="disabled" required />
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-primary border border-primary text-white">
                ...
                <input type="hidden" name="item_uuid" id="item_uuid" value="{{ $game->uuid }}" required />
