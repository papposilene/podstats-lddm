@extends('layouts.app')
@section('title', @ucfirst(__('app.seasonStats', ['season' => $season])))

@section('content')
<div class="row row-cols-1 mt-2">
    <div class="col mb-4">
        <div class="card">
            <h1 class="h5 card-header">@ucfirst(__('app.seasonStats', ['season' => $season]))</h1>
            <div class="card-body">
        ...
        <div class="card">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <span>{{ $season_has_contacts[0] }}</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <span>@ucfirst(__('app.statGames'))</span>
                    <span>{{ $season_has_games[0] }}</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
...
$.getJSON("{{ route('api.seasons.stats', ['season' => $season]) }}", function (json) {
    ...
    var chartSeason = new Chart(pieSeason, {
        ...
        data: {
            labels: labSeason,
            datasets: [{
                    label: '@ucfirst(__('app.contacts'))',
                    backgroundColor: '#6c757d',
                    borderColor: '#000',
                    data: Object.values(contacts[0])
                },
                {
                    label: '@ucfirst(__('app.tracks'))',
...
$.getJSON("{{ route('api.seasons.months', ['season' => $season]) }}", function (json) {
...
$.getJSON("{{ route('api.episode.continents', ['season' => $season]) }}", function (json) {
...
$.getJSON("{{ route('api.episode.genders', ['season' => $season]) }}", function (json) {
...
$.getJSON("{!! route('api.game.genres', ['season' => $season, 'count' => 10]) !!}", function (json) {
...
$.getJSON("{{ route('api.game.modes', ['season' => $season]) }}", function (json) {
