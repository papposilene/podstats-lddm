                ...
                <table class="table table-dark table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">@ucfirst(__('app.company'))</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.manufacturer.show', ['uuid' => $console->manufacturer_uuid]) }}">
                                    {{ $console->byManufacturer->company }}
                                </a>
                            </td>
                            <td>{{ $console->name }}</td>
                            <td class="text-center">{{ $console->released_on }}</td>
